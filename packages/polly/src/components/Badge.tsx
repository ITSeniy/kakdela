...
type BadgeVariant = 'role' | 'live' | 'mention' | 'count' | 'nsfw'
...
const VARIANT_CLASS: Record<BadgeVariant, string> = {
  ...
  // NSFW · 18+: danger-обводка, для канала с пометкой «для взрослых»
  nsfw: 'text-[8px] px-1 py-px rounded bg-kd-danger/15 text-kd-danger font-mono font-bold uppercase tracking-[0.05em]',
}
